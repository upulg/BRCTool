...
public class DateTimeTableEditor extends AbstractCellEditor
    ...
    public DateTimeTableEditor(String dateTimeFormat) {
        this(true, true, true);
    ...
    public Object getCellEditorValue() {
        LocalDateTime time = dateTimePicker.getDateTimePermissive();
        String text = time.format(DateTimeFormatter.ofPattern(this.dateTimeFormat));
        return text;
    }
    ...
    public void setCellEditorValue(Object value) {
        ...
        if (value instanceof LocalDateTime) {
            ...
            String text = new SimpleDateFormat(this.dateTimeFormat).format((Date)value);
