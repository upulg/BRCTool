...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        reticDataEntryTable.addTab("Reservoir Data Entry", jPanel1);
    ...
    private void setReticWarningText(ReticEntry lastRecord) {
        ...
        if(isWarning){
            this.jPanelReticFullLabel.setText("Interfere at the reservoir : 0.2 <= value <= 0.4");
            this.jPanelReticFullLabel.setForeground(Color.red);
        } else {
            this.jPanelReticFullLabel.setText("Safe  - Operate without interference \n" +
"at the reservoir.");
    ...
    private void setChloramineWarningText(WaterDetail lastData) {
        ...
        if (isWarning){
            this.jPanelChloramineFullLabel.setText("If dosed, dosign is not effective and\n" +
"break point chlorination is occuring!!\n" +
"If not dosed, chloramine within reservoir is decaying faster than it should!! :0.2 <= value <= 0.4");
            this.jPanelChloramineFullLabel.setForeground(Color.red);
        } else {
            this.jPanelChloramineFullLabel.setText("Reservoir is doing well \n" +
"or Dosing is effective!!");
    ...
    private void setNitritionWarningText(WaterDetail lastRecord) {
        ...
        if (isWarning){
            this.jPanelNitrificationFullLabel.setText("Interfere : 0.2 <= value <= 0.4");
            this.jPanelNitrificationFullLabel.setForeground(Color.red);
        } else {
            this.jPanelNitrificationFullLabel.setText("Safe - Operate without interference");
