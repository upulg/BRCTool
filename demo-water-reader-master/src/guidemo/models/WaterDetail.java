...
public class WaterDetail {
    ...
    public void calculateValue() {
        this.umkd = -0.0008 * Math.pow(this.temperature, 3) + 0.0419 * Math.pow(this.temperature, 2) - 0.6253 * this.temperature + 3.9132 + 0.2300;
        this.kn = this.nh3 - this.tciOut / 5.0000;
        this.brc = this.umkd * this.kn / (this.kn + 0.1800);
        this.retTime = 55.0000;
        this.krt = +(this.tciIn / this.tciOut - 1.0000) * 1.0000 / this.retTime;
        this.krt20 = Math.exp(-6900 * (1.0000 / 293.0000 - 1.0000 / (273.0000 + this.temperature))) * this.krt;
